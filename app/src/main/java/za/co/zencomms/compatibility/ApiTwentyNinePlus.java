 ...
 */
package za.co.zencomms.compatibility;

import static za.co.zencomms.compatibility.Compatibility.INTENT_ANSWER_CALL_NOTIF_ACTION;
import static za.co.zencomms.compatibility.Compatibility.INTENT_HANGUP_CALL_NOTIF_ACTION;
import static za.co.zencomms.compatibility.Compatibility.INTENT_LOCAL_IDENTITY;
import static za.co.zencomms.compatibility.Compatibility.INTENT_MARK_AS_READ_ACTION;
import static za.co.zencomms.compatibility.Compatibility.INTENT_NOTIF_ID;
import static za.co.zencomms.compatibility.Compatibility.INTENT_REPLY_NOTIF_ACTION;
import static za.co.zencomms.compatibility.Compatibility.KEY_TEXT_REPLY;
...
import za.co.zencomms.notifications.Notifiable;
import za.co.zencomms.notifications.NotificationBroadcastReceiver;
