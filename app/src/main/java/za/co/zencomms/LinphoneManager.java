...
import za.co.zencomms.assistant.PhoneAccountLinkingAssistantActivity;
import za.co.zencomms.call.AndroidAudioManager;
import za.co.zencomms.call.CallManager;
...
import za.co.zencomms.utils.MediaScanner;
import za.co.zencomms.utils.PushNotificationUtils;
...
public class LinphoneManager implements SensorEventListener {
        ...
        mCoreListener =
                new CoreListenerStub() {
                    ...
                    public void onFriendListCreated(Core core, FriendList list) {
                        if (za.co.zencomms.LinphoneContext.isReady()) {
    ...
    public static synchronized LinphoneManager getInstance() {
        LinphoneManager manager = za.co.zencomms.LinphoneContext.instance().getLinphoneManager();
        if (manager == null) {
