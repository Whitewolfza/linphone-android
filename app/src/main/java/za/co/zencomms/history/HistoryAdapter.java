...
import za.co.zencomms.utils.SelectableAdapter;
...
public class HistoryAdapter extends SelectableAdapter<HistoryViewHolder> {
    ...
    public HistoryAdapter(
        ...
        Collections.sort(
                mLogs,
                new Comparator<CallLog>() {
                    public int compare(CallLog obj1, CallLog obj2) {
                        if (obj1.getStartDate() == 0 || obj2.getStartDate() == 0) {
                            return 0;
                        }
                        return new Date(obj1.getStartDate())
                                .compareTo(new Date(obj2.getStartDate()));
                    }
                });
