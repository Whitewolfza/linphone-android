...
import za.co.zencomms.call.CallActivity;
import za.co.zencomms.call.CallIncomingActivity;
import za.co.zencomms.call.CallOutgoingActivity;
import za.co.zencomms.chat.ChatActivity;
import za.co.zencomms.compatibility.Compatibility;
import za.co.zencomms.contacts.ContactsActivity;
import za.co.zencomms.contacts.ContactsManager;
import za.co.zencomms.contacts.LinphoneContact;
import za.co.zencomms.dialer.DialerActivity;
import za.co.zencomms.fragments.EmptyFragment;
import za.co.zencomms.fragments.StatusBarFragment;
import za.co.zencomms.history.HistoryActivity;
import za.co.zencomms.menu.SideMenuFragment;
import za.co.zencomms.service.LinphoneService;
import za.co.zencomms.settings.LinphonePreferences;
import za.co.zencomms.settings.SettingsActivity;
import za.co.zencomms.utils.DeviceUtils;
import za.co.zencomms.utils.LinphoneUtils;
...
public abstract class MainActivity extends LinphoneGenericActivity
    ...
    private void quit() {
        // TODO: unregister (NOt Working ...)
        //        Core core = LinphoneManager.getCore();
        //        //        core.clearAllAuthInfo();
        //        //        core.clearProxyConfig();
        //        //        core.refreshRegisters();
        //        ProxyConfig proxyCfg = core.getDefaultProxyConfig();
        //        proxyCfg.edit(); /*start editing proxy configuration*/
        //        proxyCfg.enablePublish(true);
        //        proxyCfg.setPublishExpires(0);
        //        proxyCfg.enableRegister(false); /*de-activate registration for this proxy config*/
        //        proxyCfg.done(); /*initiate REGISTER with expire = 0*/
        //        core.refreshRegisters();
        //
        //        while (core.getDefaultProxyConfig().getState() != RegistrationState.Cleared) {
        //            core.iterate();
        //            try {
        //                Thread.sleep(100000);
