...
public class AboutActivity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpannableString undelinedText = new SpannableString(privacyPolicy.getText().toString());
        undelinedText.setSpan(new UnderlineSpan(), 0, undelinedText.length(), 0);
        privacyPolicy.setText(undelinedText);
        ...
        undelinedText = new SpannableString(license.getText().toString());
        undelinedText.setSpan(new UnderlineSpan(), 0, undelinedText.length(), 0);
        license.setText(undelinedText);
        ...
        // TODO: Get logs end send to bugnet
