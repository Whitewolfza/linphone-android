 ...
 */
package za.co.zencomms.contacts;
...
import za.co.zencomms.contacts.views.ContactAvatar;
...
public class ContactDetailsFragment extends Fragment implements ContactsUpdatedListener {
    ...
    private void displayContact(LayoutInflater inflater, View view) {
        ...
        for (LinphoneNumberOrAddress noa : mContact.getNumbersOrAddresses()) {
            ...
            SpannableString displayedNumberOrAddressUnerlinded =
                    new SpannableString(displayedNumberOrAddress);
            displayedNumberOrAddressUnerlinded.setSpan(
                    new UnderlineSpan(), 0, displayedNumberOrAddressUnerlinded.length(), 0);
            //            tv.setText(displayedNumberOrAddress);
            tv.setText(displayedNumberOrAddressUnerlinded);
            tv.setSelected(true);
            tv.setTag(displayedNumberOrAddress);
